...
/**
 * Manages "Authentication" to Weathery's backend service.  The SyncAdapter framework
 ...
 */
public class WeatheryAuthenticator extends AbstractAccountAuthenticator {

    public WeatheryAuthenticator(Context context) {
        super(context);
    }
